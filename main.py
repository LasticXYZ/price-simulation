...
def get_slider_input(config):
    # Create a slider for the sale start and price
    initial_bought_price = st.slider('Initial Bought Price', min_value=0, max_value=2000, value=1000, step=10)
    ...
    return initial_bought_price, sale_start, price, observe_blocks, sold_cores_in_each_sale
...
def main():
    ...
    initial_bought_price, sale_start, initial_price, observe_blocks, sold_cores_in_each_sale = get_slider_input(config)
    ...
    for region_i in range(region_nb):
        ...
        sale_prices = [price_calculator.calculate_price(initial_bought_price, region_start, config, price, block_now) for block_now in block_times]
